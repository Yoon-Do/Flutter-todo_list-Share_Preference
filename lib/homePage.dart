  ...
  makeListTile(Todo todo, index) {
    return ListTile(
        ...
        title: Row(
          ...
          children: [
            Flexible(
              ...
              Flexible(flex: 1,child: Container(child: todo.status ? Icon(Icons.verified_user_outlined,color: Colors.green ) : Icon(Icons.verified_user_outlined, color: Colors.red, ))),
        ...
        trailing: InkWell(
            ...
            child: Icon(Icons.delete, color: Colors.black54, size: 30.0)));
  }
